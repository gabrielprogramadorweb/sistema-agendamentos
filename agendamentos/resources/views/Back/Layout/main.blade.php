                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        ...
                                        <div>
                                            ...
                                            <span class="font-weight-bold">
                                                {{ $data['user_name'] }} agendou {{ $data['procedure_name'] }} no dia {{ $data['day'] }}/{{ $data['month'] }} às {{ $data['hour'] }}
                                            </span>
                                        </div>
                                    </a>
                                @endforeach
                        ...
                        <div class="hidden sm:flex sm:items-end sm:ml-6">
                            ...
                            <x-dropdown align="right" width="48">
                                ...
                                <x-slot name="content">
                                    ...
                                    <x-dropdown-link :href="route('web-home.index')">
                                        {{ __('Área do cliente') }}
                                    </x-dropdown-link>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Estética Dental 2024</span>
                </div>
            </div>
        </footer>
    </div>
