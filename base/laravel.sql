...
--
-- Host: setup-mysql
-- Tempo de geração: 05-Ago-2024 às 01:41
...
('7f048bac-3a0c-48ff-b3e7-131ffe73477b', 'App\\Notifications\\ScheduleCreatedNotification', 'App\\Models\\User', 3, '{\"unit_id\":100,\"service_id\":2,\"month\":\"09\",\"day\":\"03\",\"hour\":\"11:30\",\"chosen_date\":\"2024-09-03 11:30:00\",\"user_name\":\"Administrador\",\"procedure_name\":\"Checkup Dent\\u00e1rio\"}', NULL, '2024-08-04 19:20:03', '2024-08-04 19:20:03'),
...
INSERT INTO `schedules` (`id`, `user_id`, `unit_id`, `service_id`, `month`, `day`, `hour`, `created_at`, `updated_at`, `finished`, `canceled`, `chosen_date`, `status_id`) VALUES
(85, 2, 100, 2, '11', '01', '10:30', '2024-05-29 19:35:51', '2024-05-29 19:35:51', 0, 0, '2024-11-01 10:30:00', 2),
(87, 2, 100, 4, '08', '21', '11:50', '2024-05-29 19:50:35', '2024-05-29 19:50:35', 0, 0, '2024-08-21 11:50:00', 2),
(88, 2, 101, 2, '09', '18', '13:30', '2024-05-29 19:50:54', '2024-05-29 19:50:54', 0, 0, '2024-09-18 13:30:00', 2),
(89, 2, 101, 1, '09', '03', '14:00', '2024-05-29 19:51:11', '2024-05-29 19:51:11', 0, 0, '2024-09-03 14:00:00', 2),
(104, 3, 101, 2, '06', '04', '20:00', '2024-06-01 14:22:53', '2024-06-01 14:22:53', 0, 0, '2024-06-04 20:00:00', 2),
(105, 2, 101, 2, '08', '06', '14:00', '2024-06-01 15:00:40', '2024-06-01 15:00:40', 0, 0, '2024-08-06 14:00:00', 2),
(106, 2, 100, 1, '06', '19', '10:20', '2024-06-01 15:01:50', '2024-06-01 15:01:50', 0, 0, '2024-06-19 10:20:00', 2),
(107, 2, 101, 1, '10', '01', '11:00', '2024-06-01 15:12:42', '2024-06-01 15:12:42', 0, 0, '2024-10-01 11:00:00', 2),
(108, 2, 100, 1, '06', '12', '09:00', '2024-06-01 15:56:37', '2024-06-01 15:56:37', 0, 0, '2024-06-12 09:00:00', 2),
(109, 2, 101, 2, '09', '03', '09:30', '2024-06-01 16:09:28', '2024-06-01 16:09:28', 0, 0, '2024-09-03 09:30:00', 2),
(110, 2, 100, 1, '09', '02', '09:00', '2024-06-01 16:10:55', '2024-08-04 22:38:16', 0, 0, '2024-09-02 09:00:00', 2),
(111, 3, 100, 3, '06', '04', '11:20', '2024-06-01 21:24:53', '2024-08-04 22:23:13', 0, 0, '2024-06-04 11:20:00', 3),
(112, 3, 100, 2, '09', '03', '11:30', '2024-08-04 19:20:03', '2024-08-04 22:39:24', 0, 0, '2024-09-03 11:30:00', 4);
...
--
-- Estrutura da tabela `status_agendamento`
--
...
--
-- Extraindo dados da tabela `status_agendamento`
--

INSERT INTO `status_agendamento` (`id`, `status`) VALUES
(1, 'confirmado'),
(2, 'agendado'),
(3, 'cancelado'),
(4, 'concluido');
...
ALTER TABLE `schedules`
  ...
  ADD KEY `fk_status_agendamento` (`status_id`);
...
--
-- Índices para tabela `status_agendamento`
--
...
--
ALTER TABLE `schedules`
  ADD CONSTRAINT `fk_status_agendamento` FOREIGN KEY (`status_id`) REFERENCES `status_agendamento` (`id`),
